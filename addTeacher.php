...
if (isset($_POST['sub'])) {
    ...
    try {
        ...
        if ($fullname != "" && $fathername != "" && $gfathername != "" && $photo != "" && $tazkira != "" && $gender != "" && $dob != "" && $position != "" && $date != "" && $phone != "" && $address != "") {
            ...
            $sql = "INSERT INTO teacher SET fullname=?, fathername=?, gfathername=?, photo=?, tazkira=?, gender=?, dob=?, position=?, `date`=?, phone=?, `address`=?";
        ...
        <div class="row">
            ...
            <form method="POST" class="form col-8 offset-2 d-flex flex-wrap justify-content-center mt-3" dir="rtl">
                ...
                <div class="col-5 mb-3">
                    ...
                    <select name="position" id="class" class="form-control">
